...
class ReflectionProcessor extends AbstractProcessor {
    ...
    private void addFullyQualifiedDeclaredMethod(String descriptor) {
        ...
        configuration.getOrCreateType(ConfigurationCondition.objectReachable(), qualifiedClass).addMethod(methodName, signature, ConfigurationMemberDeclaration.DECLARED);
    }
