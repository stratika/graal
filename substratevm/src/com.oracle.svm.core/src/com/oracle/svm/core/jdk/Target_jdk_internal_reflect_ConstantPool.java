...
public final class Target_jdk_internal_reflect_ConstantPool {
    @Inject private final CodeInfo info;

    public Target_jdk_internal_reflect_ConstantPool(CodeInfo info) {
        this.info = info;
    }
    ...
    public String getStringAt(int index) {
        return NonmovableArrays.getObject(CodeInfoAccess.getFrameInfoSourceMethodNames(info), index);
    }
